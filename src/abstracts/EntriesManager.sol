 ...
 * @notice Manager contract to handle acquisition of `Raffl` entries.
 * @dev This is an extract of @cygaar_dev and @vectorized.eth [ERC721A](https://erc721a.org) implementation.
 *
 * Assumptions:
 *
...
abstract contract EntriesManager {
    ...
    function _packedOwnershipExists(uint256 packed) private pure returns (bool result) {
        assembly {
            // The following is equivalent to `owner != address(0)`.
            result := and(packed, _BITMASK_ADDRESS)
        }
    }
    ...
    function _mint(address to, uint256 quantity) internal virtual {
        ...
        unchecked {
            ...
            _packedOwnerships[startTokenId] = _packOwnershipData(to);
